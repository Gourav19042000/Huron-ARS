...
const AutomobileCard = (automobile) => {
  ...
  const onClickRemoveItem = (automobile) => {
    dispatch(removeItem(automobile));
  };
      ...
      <div className=" p-[20px]  rounded-xl ">
        <div className="shadow-xl border-solid border-2 h-[430px] border-black rounded-xl w-[300px] p-2">
          ...
          <div className="justify-center">
            <button
              type="button" onClick={()=>onClickRemoveItem(automobile)}
              className="text-white w-[100%] mt-7 bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 me-4 mb-4 dark:bg-blue-600 "
            >
              Remove
            </button>
          </div>
